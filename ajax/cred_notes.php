...
/*  ajax/cred_notes.php
    ...
    INPUT $_REQUEST['value']: new note, which overwrites the old; anything past 1024 characters is ignored. 
...
$value = trim($value);
$value = substr($value, 0, 1024); // >>>00002 Not that truncation is likely, but if it happens it should log.
