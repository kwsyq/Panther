 ...
 * @since 2.2
 */
class Logger2ConfiguratorDefault implements Logger2Configurator
{
	 ...
	 * 		will be used.
	 */
	public function configure(Logger2Hierarchy $hierarchy, $input = null) {
	 ...
	 * @param array $config
	 */
	private function doConfigure(Logger2Hierarchy $hierarchy, $config) {
	...
	private function configureRenderer(Logger2Hierarchy $hierarchy, $config) {
	...
	private function configureDefaultRenderer(Logger2Hierarchy $hierarchy, $class) {
		if (empty($class)) {
	 ...
	 * @see configureLogger() 
	 */
	private function configureRootLogger(Logger2Hierarchy $hierarchy, $config) {
	 ...
	 * @see configureLogger()
	 */
	private function configureOtherLogger(Logger2Hierarchy $hierarchy, $name, $config) {
