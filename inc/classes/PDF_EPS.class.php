<?php 
/* PDF_EPS.class.php
   A third-party extension to FPDF. PostScript extension for FPDF. Documented at http://valentin.dasdeck.com/fpdf/fpdf_eps/. 
   Allows vector-based Adobe Illustrator (AI) or AI compatible EPS files to be embedded in a PDF.
   
    >>>00001: I have not studied this file at all closely, not even formal cleanup, just this header. 
    Could doubtless use some cleanup (layout is pretty weird) & some documentation work. - JM 2019-02-26   
*/
