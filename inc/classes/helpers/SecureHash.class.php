<?php
/* SecureHash.class.php

   EXECUTIVE SUMMARY: Unlike most other helper classes, this one is quite widely used. 
   Taken from https://gist.github.com/cballou/2439237. 
   
   * Public methods 
   ** create_hash($password, &$salt = '', $stretch_cost = 10)
   ** validate_hash($pass, $hashed_pass, $salt)
*/
