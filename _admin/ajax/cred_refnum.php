...
/*  _admin/ajax/cred_refnum.php
    ...
    INPUT $_REQUEST['value']: value for column "referenceNumber". This is typically something like a 
        check number or PayPal transaction number. Will be trimmed to 64 characters.
   ...
   >>>00037 Common code should be eliminated: this is extremely similar to ajax/cred_refnum.php, they should share common code.
...
$value = trim($value);
$value = substr($value, 0, 64); // >>>00002: truncates silently
