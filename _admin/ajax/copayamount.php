<?php
/* _admin/ajax/copayamount.php

    EXECUTIVE SUMMARY: Update copay for indicated row in DB table customerPersonPayPeriodInfo as specified.
    ...
    INPUT: $_REQUEST['value']. New copay value for the indicated row in DB table customerPersonPayPeriodInfo. 
        ...
        if (intval($parts[0])) {
            if (intval($parts[1])) {
                if (is_numeric($value)) {
                    ...
                    $query .= " copay = " . $db->real_escape_string($value) . " ";
