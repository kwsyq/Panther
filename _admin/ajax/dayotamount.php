<?php
/* _admin/ajax/dayotamount.php

    EXECUTIVE SUMMARY: Update dayOT for indicated row in DB table customerPersonPayWeekInfoInfo as specified. 
    ...
    INPUT $_REQUEST['value']. New dayOT value for the indicated row in DB table customerPersonPayWeekInfoInfo. Relevant column data type is TINYINT(4). 
